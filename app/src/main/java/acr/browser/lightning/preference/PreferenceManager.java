...
public class PreferenceManager {
    ...
    public void setRewardedVideoOnChangeTheme(boolean enabled) {
        putBoolean(Name.REWARDED_VIDEO_CHANGE_THEME, enabled);
    }

    public boolean getRewardedVideoOnChangeTheme() {
        return mPrefs.getBoolean(Name.REWARDED_VIDEO_CHANGE_THEME, true);
    }

    public void setRewardedVideoOnIncognitoTab(boolean enabled) {
        putBoolean(Name.REWARDED_VIDEO_INCOGNITO_TAB, enabled);
    }

    public boolean getRewardedVideoOnIncognitoTab() {
        return mPrefs.getBoolean(Name.REWARDED_VIDEO_INCOGNITO_TAB, true);
    }

    public void setRewardedVideoInterval(int interval) {
        putInt(Name.REWARDED_VIDEO_INTERVAL_IN_MINUTES, interval);
    }

    public int getRewardedVideoInterval() {
        return mPrefs.getInt(Name.REWARDED_VIDEO_INTERVAL_IN_MINUTES, 1);
    }

    public void setRewardedVideoOnSearchEngine(boolean enabled) {
        putBoolean(Name.REWARDED_VIDEO_SEARCH_ENGINE_CHANGE, enabled);
    }

    public boolean getRewardedVideoOnSearchEngine() {
        return mPrefs.getBoolean(Name.REWARDED_VIDEO_SEARCH_ENGINE_CHANGE, false);
    }

    public void setRewardedVideoOnProxuSetUp(boolean enabled) {
        putBoolean(Name.REWARDED_VIDEO_PROXY_SET_UP, enabled);
    }

    public boolean getRewardedVideoOnProxuSetUp() {
        return mPrefs.getBoolean(Name.REWARDED_VIDEO_PROXY_SET_UP, false);
    }

    public void setRewardedVideoOnTextSizeChangin(boolean enabled) {
        putBoolean(Name.REWARDED_VIDEO_TEXT_SIZE_CHANGE, enabled);
    }

    public boolean getRewardedVideoOnTextSizeChangin() {
        return mPrefs.getBoolean(Name.REWARDED_VIDEO_TEXT_SIZE_CHANGE, false);
    }

    public void setRewardedVideoOnClickNews(boolean enabled) {
        putBoolean(Name.REWARDED_VIDEO_CLICK_NEWS, enabled);
    }

    public boolean getRewardedVideoOnClickNews() {
        return mPrefs.getBoolean(Name.REWARDED_VIDEO_CLICK_NEWS, false);
    }

    public void setRewardedVideoLastViewTime(long lastViewTime) {
        putLong(Name.REWARDED_VIDEO_LAST_VIEW_TIME, lastViewTime);
    }

    public long getRewardedVideoLastViewTime() {
        return mPrefs.getLong(Name.REWARDED_VIDEO_LAST_VIEW_TIME, Long.valueOf(0));
    }
