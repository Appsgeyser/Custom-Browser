...
public class Config {
    ...
    public Config(Context context, PreferenceManager mPreferenceManager) {
        ...
        try {
            ...
            mPreferenceManager.setToolBarStyle(viewSettings.getString("toolBarStyle"));
            ...
            toolbarPosition = viewSettings.getString("toolbarPosition");
            ...
            homepageTabs = homepageTabsObject.getString("homepageTabs");
            ...
            weatherWidgetType = weatherWidget.getString("weatherWidgetType");
            ...
            bookmarkWidgetType = bookmarkWidget.getString("bookmarkWidgetType");
            ...
            downloadsWidgetType = downloadsWidget.getString("downloadsWidgetType");
            ...
            historyWidgetType = historyWidget.getString("historyWidgetType");
            ...
            newsWidgetType = newsWidget.getString("newsWidgetType");
            newsTabsPosition = newsWidget.getString("newsTabsPosition");
