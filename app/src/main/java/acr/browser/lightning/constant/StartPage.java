...
public class StartPage {
    ...
    private static final String HEAD_2 = "</title>"
            + "</head>"
            + "<style>body{text-align:center;margin:0px;}#search_input{height:35px; "
            ...
            + "background-color:transparent;}.outer { background-image:url(";
    private static final String HEAD_3 =
            ...
            + "border-radius: 2px;}</style><body></body>";// <div class=\"outer\"><div class=\"middle\"><div class=\"inner\"><img class=\"smaller\" src=\"";
    ...
    public Single<String> getHomepage() {
        return Single.create(new SingleAction<String>() {
            ...
            public void onSubscribe(@NonNull SingleSubscriber<String> subscriber) {
                ...
                homepageBuilder.append("file:///android_asset/").append(BrowserApp.getConfig().getBackgroundUrl());
                homepageBuilder.append(HEAD_3);
